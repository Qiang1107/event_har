...
def main(config_path, premodel_path, log_path):
    ...
    with open(log_path, 'a') as f:
        ...
        if model_type == 'vit':
            ...
            f.write(f" ------{model_type} Configuration------\n")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='results/checkpoints/pointnet2_event_0628_8_ecount_11.pth', # respre_rgb_0628_8_3.pth
