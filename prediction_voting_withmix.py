...
def analyze_voting_results(window_results, all_predictions, class_names, log_path, cfg, model_path, time_window_sec, timestamp):
    """分析时间窗口投票结果"""
...
def main(config_path, model_path, vote_data_path, log_path=None, time_window_sec=1.0):
    ...
    window_results, all_predictions = predictor.predict_with_vote_dataset(
    ...
    # 6. 分析结果
    analysis_results = analyze_voting_results(window_results, all_predictions, class_names, log_path, cfg, model_path, time_window_sec, timestamp)
